...
<title>Spas-Polaris Retreats</title>
...
<div class="main">
<h1 id="title">Polaris Retreats Spa Packages</h1>
...
while($row = mysqli_fetch_assoc($result)){
	...
	echo "<h3>".$row['PackageType']." at ".$row['name']."</h3>".
	"<p>"."£".$row['Price']."<br> Address:".$row['fullAddress']."<br>";	
	if(isset($_COOKIE["customer"])){

	echo "<form action=\"SpaAddedToCart.php\" method=\"post\"><input type=\"hidden\" name=\"packagetype\" value=\"".$row["PackageType"]."\">".
