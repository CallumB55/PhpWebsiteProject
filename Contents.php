...
<title>Contents-Polaris Retreats</title>
...
<div class="main">
<h1 id="title">Polaris Retreats Contents</h1>
...
<ol>
	...
	<li><a href="RegisterAccount.php">Register account</a></li>
	</br>
	<li><a href="Report.php">Report</a></li>
	<?php
	if(isset($_COOKIE["customer"])){if($_COOKIE["customer"] != 'admin@pr.com'){$hasAccess=False;}else{$hasAccess=True;}}else{$hasAccess = False;}
	...
	<br>
	<li><a href="SignedOut.php">Sign out</a></li>
</ol>
