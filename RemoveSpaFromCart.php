...
<?php
	...
	$spa2DeleteQ = "delete from cart where SpaPackageID =".$_POST["spaPackageID"]." and CustomerEmail='".$_COOKIE["customer"]."' and startDate='".$_POST["date"]."'  limit 1";
	
	$spa2Delete = mysqli_query($db, $spa2DeleteQ);
	}
