...
<title>Register Account-Polaris Retreats</title>
...
<p id="bodyText">
<form name="accountForm" action="AccountCreated.php" method="post">
...
<label for="secondName"> Second name:</label><input type="text" id="secondName" name="secondName" required><br><br>
  Gender:
...
<label for="PhoneNo">Phone No.:</label><input type="text" id="PhoneNo" name="PhoneNo" ><br><br>
Address: <br>
<label for="BuildingName">Building name:</label><input type="text" id="BuildingName" name="BuildingName" required><br><br>
<label for="StreetName">Street name:</label><input type="text" id="StreetName" name="StreetName" required><br><br>
<label for="CityName">City name:</label><input type="text" id="CityName" name="CityName" required><br><br>
<label for="PostCode">Postcode:</label><input type="text" id="PostCode" name="PostCode" required><br><br>
