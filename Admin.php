...
<title>Admin Tools-Polaris Retreats</title>
...
<div class="main">
<h1 id="title">Polaris Retreats Admin Tools</h1>




<p id="bodyText" <?php if(isset($_COOKIE["customer"])){if($_COOKIE["customer"] != 'admin@pr.com'){echo "aria-hidden=\"true\"";}}else{echo "aria-hidden=\"true\"";} ?>>
<?php
if(isset($_COOKIE["customer"])){if($_COOKIE["customer"] != 'admin@pr.com'){$hasAccess=False;}else{$hasAccess=True;}}else{$hasAccess = False;}
if($hasAccess){
...
<input type=\"submit\" name=\"changePsw\" value=\"change password\" >
<input type=\"submit\" name=\"getPsw\" value=\"get password\" >
</form>
";
}
?>
